...
// here.
// postcodeToState now lives in warehouse/scripts/lib/postcode_to_state.mjs
// (Sprint 12 WS6 — extracted so the rollup script can share one
// implementation instead of maintaining a second copy).
